...
def create_cost_details(from_date: datetime | None = None, to_date: datetime | None = None) -> None:
    ...
    refund_prices = SpotPriceRefund.objects.all()
    ...
    if from_date:
        ...
        refund_prices = refund_prices.filter(start_date__gte=from_date.date())
    if to_date:
        ...
        refund_prices = refund_prices.filter(start_date__lt=to_date.date())
